package com.example.demo.repository.finance;
...
public interface financeRepository {
    ...
    @Select({" SELECT  biz_claim_voucher.`id` bId,\n" +
            ...
            "        biz_claim_voucher.`STATUS`  IN('待付款') order by" +
    ...
    List<findAllExpenseDto> findExpenseByTime(@Param("bStatus") String status, @Param("startTime") String startTime, @Param("endTime") String endTime);
    ...
    List<bizClaimVoucherDetail> findBizClaimVoucherDetail(@Param("id") Integer id);
    ...
    resultDTO findComm(@Param("id") Integer cId,@Param("chesn") String chesn);
    ...
    String findEmployeeId(@Param("namecn") String name_cn);
