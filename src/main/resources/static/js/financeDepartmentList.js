...
$(function () {
   ...
   $.ajax({
       type:"get",
      url:"http://localhost:8080/financeList/ShowList",
       data:{},
       datatype:"json",
           ...
           for(var i=0;i<da.length;i++){
               if (da[i].bstatus=="待付款"){
                   $("#datatbody").append(" <tr>\n"+
                       ...
                       "<td>"+da[i].btime+"</td>\n"+
                       "<td>\n"+
                       "<span onclick='selectApprove("+da[i].bid+")' class=\"glyphicon glyphicon-ok\"></span>&nbsp;&nbsp;\n"+
                       "</td>\n"+
                       "</tr>");
               }else {
                   $("#datatbody").append(" <tr>\n"+
 ...
 /*     if(startTime!=""&&endTime!=""){
          $.ajax({
              type:"get",
             url:"http://localhost:8080/financeList/ShowListByBstatusbyTime/"+bStatus+"/"+startTime+"/"+endTime,
              data:{},
              datatype:"json",
              success:function (data) {
                  var da=data["data"];
          ...
          $.ajax({
              type:"get",
             url:"http://localhost:8080/financeList/ShowListByBstatus/"+bStatus,
              data:{},
              datatype:"json",
              success:function (data) {
                  var da=data["data"];
...
function selectApprove(i) {
  $(function () {
location. href="http://localhost:8080/page/selectApproves/"+i;
  });
