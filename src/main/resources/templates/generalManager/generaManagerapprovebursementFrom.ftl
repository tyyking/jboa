...
<head>
    ...
    <script src="../../js/generaManagerappperovebursementFrom.js"></script>
</head>
                                    ...
                                    <div class="panel-group" id="panel-536715">
                                        <div class="panel panel-default">
                                            ...
                                            <div id="panel-element-857286" class="panel-collapse in">
                                                <a  href="http://localhost:8080/page/generpageshow"><div class="panel-body">
                                                    &nbsp; &nbsp; &nbsp;<span
                                                                ...
                                                                <div class="col-md-12 column">
                                                                    <div class="row clearfix">
                                                                        <div class="col-md-1 column">
                                                                            <div class="row clearfix">
                                                                                <div class="col-md-12 column">
                                                                                    <span style="font-size:12px">审批报销单</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                    ...
                                    <div>
                                        <div class="row" style="width: auto">
                                            <div class="col-md-12 column">
                                                <!---------------------------------------------数据列表------------------------------------------------------------------------>
                                                <h4>基本信息</h4>
                                                <span id="ids" style="display: none">${id}</span>
                                                <table id="tab">
                                                ...
                                                <table id="tab2">
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <td colspan="3">审批意见:<textarea style="resize:none"
                                                                                       placeholder="请填写请假事由..."></textarea>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <button  id="passs" class="btn btn-primary btn-small" type="button">审批通过
                                                            </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <button id="refuses" class="btn btn-primary btn-small" type="button">审批拒绝
                                                            </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <button id="beatback" class="btn btn-primary btn-small" type="button">打回
                                                            </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <button id="barck" class="btn btn-primary btn-small" type="button">返回
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    </tbody>
