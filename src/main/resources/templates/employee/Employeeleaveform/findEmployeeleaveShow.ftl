...
<head>
    ...
    <script src="../../js/findEmployeeleaveShow.js"></script>
</head>
                                            ...
                                            <div class="col-md-12 column">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbods>
                                                        <tr>
                                                            <td >&nbsp;&nbsp;
                                                                <button id="update" type="button" class="btn btn-default btn-info">提交修改
                                                                </button>
                                                            </td>
                                                            <td >&nbsp;&nbsp;
                                                                <button id="pass" type="button" class="btn btn-default btn-info">申请
                                                                </button>
                                                            </td>
                                                            <td >&nbsp;&nbsp;
