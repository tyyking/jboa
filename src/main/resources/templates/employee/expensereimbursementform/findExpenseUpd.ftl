...
<head>
    ...
    <script src="../../js/findExpenseUpd.js"></script>
</head>
                                            ...
                                            <div class="col-md-12 column">
                                                ...
                                                <table >
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <input type="text" name="money" onblur='add()'>*
                                                      </td>
                                                      <td>
                                                          <input type="text">*
                                                      </td>
                                                      <td><a id="addplus"><span  class="glyphicon glyphicon-plus"></span></a></td>
                                                  </tr>
                                                  </tbody>
                                                </table>
                                                <!--意见输入-->
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <td colspan="4" style="text-align: center">
                                                            <button type="button" id="add" class="btn btn-default btn-danger">保存
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    </tbody>
